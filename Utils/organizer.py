from utils import make, make_loader
import wandb
...
def organizer(One_hot_Dataframe, config):
    """
    This function trains and validates the model using different partitions of the train and test sets.
    It does it using the Train_Test_indices whihc contains the different sets indices.
    """
